        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-8">
            ...
            <div className="flex-1 pt-1">
              <label className="block text-base font-medium text-bolt-elements-textPrimary mb-1"> {/* Updated color */}
                Profile Picture
              </label>
              <p className="text-sm text-bolt-elements-textSecondary">Upload a profile picture or avatar</p> {/* Updated color */}
            </div>
          </div>
