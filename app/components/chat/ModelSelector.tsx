      ...
      <div className="relative flex-1 lg:max-w-[70%]" onKeyDown={handleKeyDown} ref={dropdownRef}>
        <div
          className={classNames(
            'w-full h-10 p-2 flex items-center rounded-lg border border-bolt-elements-borderColor', // Added h-10 and flex items-center
            ...
            <div className="px-2 pb-2">
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    'w-full pl-8 pr-3 h-9 py-2.5 rounded-md text-sm', // Adjusted height and padding
              ...
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                ...
                filteredModels.map((modelOption, index) => (
                  <div
                    ...
                    className={classNames(
                    'px-3 py-2.5 min-h-10 flex items-center text-sm cursor-pointer', // Adjusted padding and added min-height, flex
