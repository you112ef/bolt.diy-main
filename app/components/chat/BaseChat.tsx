          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[8vh] sm:mt-[12vh] lg:mt-[16vh] max-w-chat mx-auto text-center px-4 sm:px-6 lg:px-0">
                ...
                <p className="text-base sm:text-md lg:text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                ...
                >
                  ...
                  >
                    <textarea
                      ref={textareaRef}
                      className={classNames(
                        'w-full pl-3 pt-3 pr-12 sm:pl-4 sm:pt-4 sm:pr-16 outline-none resize-none text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary bg-transparent text-xs sm:text-sm',
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center text-sm p-2 sm:p-4 sm:pt-2 gap-1 sm:gap-2">
                      <div className="flex flex-wrap gap-1 items-center justify-center sm:justify-start">
                        ...
                        <IconButton
                          ...
                          disabled={!providerList || providerList.length === 0}
                        >
                          <div className={`i-ph:caret-${isModelSettingsCollapsed ? 'right' : 'down'} text-base sm:text-lg`} />
